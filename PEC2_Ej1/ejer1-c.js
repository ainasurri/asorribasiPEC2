...
async function fetchUsers(){
    ...
    await findOne(users, { key: 'name', value: 'Carlos' }) /*Amb await, el codi s'espera a que es resolgui la promise.*/
    ...
    await findOne(users, { key: 'name', value: 'Fermin' }) /*Amb await, el codi s'espera a que es resolgui la promise.*/
    .then(({ name }) => console.log(`user: ${name}`)) /*En cas que la promise es completi amb èxit, print de l'usuari.*/
    .catch (({ msg }) => console.log(msg)); /*En cas que la promise no es completi amb èxit, print del missatge d'error.*/
}
